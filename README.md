...
0. Merging raw measures of adverse childhood experiences (ACEs) into a single dataset.
1. Deriving ACE measures, psychopathology outcomes, and auxiliary variables.
2. Exploratory factor analysis.
3. Multivariate multiple regression.
4. Multiple imputation.
5. Re-deriving all measures on the imputed dataset.
6. Replicating all analyses on the imputed dataset.
